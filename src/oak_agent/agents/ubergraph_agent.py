...
ASSUMPTIONS = {
    "provenance": ("When formulating your response to tool outputs,",
    ...
    "rg": ("All edges are stored as simple triples, e.g CL:0000080 BFO:0000050 UBERON:0000179"
           " for 'circulating cell' 'part of' 'haemolymphatic fluid'"),
    "ont_graph": ("Direct (asserted) edges are stored in the `renci:ontology` graph."
                  "Use this by default, even for subClassOf."),
    "entailed": ("Indirect (entailed) edges (including reflexive) are stored in the `renci:redundant` graph"
    ...
    "blazegraph": ("Blazegraph is used as the underlying triplestore."
